...
void closedGripper(trajectory_msgs::JointTrajectory& posture)
{
  ...
  /* Add both finger joints of panda robot. */
  posture.joint_names.resize(2);
  posture.joint_names[0] = "link_06__finger_1";
  posture.joint_names[1] = "link_06__finger_2";
...
void pick(moveit::planning_interface::MoveGroupInterface& move_group)
{
  ...
  // extra padding)
  grasps[0].grasp_pose.header.frame_id = "link_06";
  ...
  grasps[0].pre_grasp_approach.direction.header.frame_id = "link_06";
  ...
  // ++++++++++++++++++++++++++
  /* Defined with respect to frame_id */
  grasps[0].post_grasp_retreat.direction.header.frame_id = "link_06";
...
void addCollisionObjects(moveit::planning_interface::PlanningSceneInterface& planning_scene_interface)
{
  ...
  collision_objects[0].primitive_poses[0].position.x = 1.5;
